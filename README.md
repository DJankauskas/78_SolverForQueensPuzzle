...
In working on this project, I utilized Piazza for precise wordings of the problem and the recursive abstraction, which goes without saying. However, this proved extremeley helpful and made the programming very quick so I'd like to give credit anyway. I also conversed with Yaru Luo and Greg Zborovsky to confirm that Java arrays were reference types. I confirmed this using [StackOverflow](https://stackoverflow.com/questions/8781022/is-an-array-an-object-in-java), where I learned Java arrays are actually Objects and thus variables are references to memory on the heap.
